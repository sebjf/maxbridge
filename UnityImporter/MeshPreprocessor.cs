...
namespace MaxUnityBridge
{
    public class ProcessedMesh
    {
        ...
        public List<FaceIndicesGroup> faces;
    }

    public class FaceIndicesGroup
    {
        public int MaterialId;
        public int[] FaceIndices;
    }

    public class VertexComponents
    {
    ...
    public partial class UpdateProcessor
    {
        ...
        /// <returns></returns>
        protected ProcessedMesh PreprocessMesh(GeometryUpdate Update)
        {
            ...
            return new ProcessedMesh { components = vertexcomponents, faces = faceindexgroups };
        }
